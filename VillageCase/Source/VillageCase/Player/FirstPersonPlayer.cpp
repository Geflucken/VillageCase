...
void AFirstPersonPlayer::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
FHitResult AFirstPersonPlayer::WeaponTrace(const FVector& StartTrace, const FVector& EndTrace) const
{
...
void AFirstPersonPlayer::TryEnableTouchscreenMovement(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(EInputEvent::IE_Repeat, this, &AFirstPersonPlayer::TouchUpdate);	
}
